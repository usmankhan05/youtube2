      ...
      <div
        className={`${
          mobileShow
            ...
            : "hidden h-[calc(100vh-6.625rem)] w-[17%]"
        } xl:static xl:block px-2 lg:px-4 overflow-y-auto scrollbar-hidden hover-scrollbar-visible`}
      >
            ...
            return (
              <div className="mb-5 ">
                ...
                {group.groupItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center space-x-6 hover:bg-gray-200 duration-300 rounded-xl py-2 px-3 "
                  >
